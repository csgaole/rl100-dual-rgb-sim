...
class FlippingEnv:
    def __init__(
        ...
        demo_path='<HOME>/project/bimanual-ur/gello_software/demo_data/demo_001.npy',  # demo 文件路径，reset_mode='demo' 时需要
    ):
...
if __name__ == '__main__':
    ...
    # 示例: 使用 demo 模式
    # python flipping_env.py --reset_mode demo --demo_path <HOME>/project/bimanual-ur/gello_software/demo_data/demo_001.npy
